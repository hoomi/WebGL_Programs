function WebGL(canvasId) {
  ...
  var initVertexBuffers = function (gl,vertices, n) {
    var a_position,
  ...
  this.drawTriangle = function() {
    var vertices = new Float32Array([
      ...
      0.5,-0.5]),
      n = 3;
    initVertexBuffers(that.gl, vertices, n);
    this.gl.drawArrays(that.gl.TRIANGLES,0,n);
  }
  ...
  this.drawRectangle = function() {
    var vertices = new Float32Array([
      ...
      n=4;
  initVertexBuffers(that.gl, vertices, n);
  this.gl.drawArrays(that.gl.TRIANGLE_STRIP,0,n);   
  }
}
